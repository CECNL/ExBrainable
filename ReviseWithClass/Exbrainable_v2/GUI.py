...
class ExBrainable():
    ...
    def Menu(self):
        ...
        self.filemenu.add_command(label='Load Model Weight', command=lambda:self.Weightname)
        ...
        self.Results.add_command(label='Model Performance', command=lambda:self.Model_performance())
